...
void loop() {
  ...
  if (millis() - last_time > 5000) {
    ...
    mean = get_mean();
    sigma = get_std(mean);
    client.publish("raspi/sensors", String("{\"room\": 1, \"node_id\": \"" + WiFi.macAddress() + "\", \"current_light\": " + String(new_data) + ", \"light_mean\": " + String(mean) + ", \"recent_changes\": " + String(sigma) + "}").c_str());
  }
}
